    ...
    public class PizzaController : Controller
    {
        ...
        public ActionResult Edit(PizzaViewModel vm)
        {
            try
            {
                ...
                PizzaModel pizza = FakeDb.Instance.Pizzas.SingleOrDefault(x => x.Id == vm.Pizza.Id);
        ...
        public ActionResult Delete(int id, FormCollection collection)
        {
            try
            {
                PizzaModel pizza = FakeDb.Instance.Pizzas.FirstOrDefault(x => x.Id == id);
